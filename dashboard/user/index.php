                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-md">
                                            ...
                                            $no = $first + 1;
                                            $data = $conn->query("SELECT * FROM user LIMIT $first, $batas");
                                            while ($user_data = mysqli_fetch_object($data)) {  ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-icon btn-primary" href="edit_user.php?id=<?= $user_data->id_user ?>">
                                                            <i class="far fa-edit"></i>
                                                        </a>
                                                        <a class="btn btn-icon btn-danger" href="delete_user.php?id=<?= $user_data->id_user ?>" onclick="return confirm_delete()">
