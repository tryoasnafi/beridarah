...
<head>
    ...
    <title>Daftar Request Aktif</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="add_request.php" class="btn btn-success">Tambah Request</a>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-md">
                                            ...
                                            $previous = $page - 1;
                                            $next = $page + 1;
                                            $count_data = mysqli_num_rows($conn->query("SELECT * FROM request"));
                                            $total_page = ceil($count_data / $batas);

                                            $no = $first + 1;
                                            $sql = "SELECT * FROM request LIMIT $first, $batas";
                                            $data = $conn->query($sql);
