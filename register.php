...
<body>
                                ...
                                <form method="POST" action="register_action.php">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <input id="password" type="password" class="form-control pwstrength" data-indicator="pwindicator" name="password" minlength="6">
                                            <div id="pwindicator" class="pwindicator">
                                                <small class="label">Minimum 6 karakter</small>
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
    ...
    <!-- JS Libraies -->
    <script src="assets/jquery-pwstrength/jquery.pwstrength.min.js"></script>
